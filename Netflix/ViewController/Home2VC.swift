...
//        collectionView.register(RecommandCell.self, forCellWithReuseIdentifier: RecommandCell.identifier)
//
...
//        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RecommandCell.identifier, for: indexPath) as? RecommandCell else { return UICollectionViewCell() }
//
...
//
//        let header = NSCollectionLayoutBoundarySupplementaryItem(layoutSize: headerSize, elementKind: SectionHeaderView.identifier[index], alignment: .leading)
//
