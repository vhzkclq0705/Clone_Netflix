...
class PlayerView2VC: UIViewController {
    ...
    lazy var jumpSecond2: UILabel = jumpSecond1
    ...
    lazy var movieSlider: UISlider = {
        ...
        slider.addTarget(self, action: #selector(adjustMovieSlider(_:)), for: .touchUpInside)
...
extension PlayerView2VC {
    func setupUI() {
        ...
        playButton.snp.makeConstraints {
            $0.centerX.centerY.equalTo(controlView)
        }
        
        backButton.snp.makeConstraints {
            $0.top.equalTo(controlView).inset(20)
            $0.right.equalTo(controlView).inset(10)
        }
        ...
        jumpBackwardButton.snp.makeConstraints {
            $0.centerY.equalTo(controlView)
            $0.right.equalTo(playButton.snp.left).inset(50)
        }
        
        jumpForwardButton.snp.makeConstraints {
            $0.centerY.equalTo(controlView)
            $0.left.equalTo(playButton.snp.right).inset(50)
        }
        
        jumpSecond1.snp.makeConstraints {
            $0.centerX.equalTo(jumpBackwardButton)
            $0.top.equalTo(jumpBackwardButton.snp.top).inset(22)
        }
        
        jumpSecond2.snp.makeConstraints {
            $0.centerX.equalTo(jumpForwardButton)
            $0.top.equalTo(jumpForwardButton.snp.top).inset(22)
        }
        
        titleLabel.snp.makeConstraints {
            $0.centerX.equalTo(controlView)
            $0.top.equalToSuperview().inset(20)
        }
        
        timeRemainingLabel.snp.makeConstraints {
            $0.bottom.equalTo(controlView).inset(50)
            $0.right.equalTo(controlView).inset(10)
        }
        
        movieSlider.snp.makeConstraints {
            $0.bottom.equalTo(controlView).inset(45)
            $0.left.equalTo(controlView).inset(20)
            $0.right.equalTo(timeRemainingLabel.snp.left).inset(50)
        }
